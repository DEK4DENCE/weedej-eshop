        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="flex gap-3">
              <a href="https://www.instagram.com/weedej.cz" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="w-8 h-8 rounded-full bg-[#F8F9FA] border border-[#DEE2E6] flex items-center justify-center text-[#6e6e73] hover:text-[#2E7D32] hover:border-[#2E7D32] transition-colors">
              ...
              <a href="https://www.facebook.com/weedej.cz" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="w-8 h-8 rounded-full bg-[#F8F9FA] border border-[#DEE2E6] flex items-center justify-center text-[#6e6e73] hover:text-[#2E7D32] hover:border-[#2E7D32] transition-colors">
